...
<table class='table table-bordered>'        
	    ...
	    <tr><td width='200'>Nama 1 <?php echo form_error('nama_1') ?></td><td><input type="text" class="form-control" name="nama_1" id="nama_1" placeholder="Nama 1" value="<?php echo $nama_1; ?>" /></td></tr>
	    <tr><td width='200'>Nama 2 <?php echo form_error('nama_2') ?></td><td><input type="text" class="form-control" name="nama_2" id="nama_2" placeholder="Nama 2" value="<?php echo $nama_2; ?>" /></td></tr>
	    ...
	    <a href="<?php echo site_url('laporanv2') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a></td></tr>
	</table></form>        </div>
</div>
</div>